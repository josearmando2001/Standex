                ...
                <div class="col-xxl-4 col-xl-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Para proceder con el registro de cliente, necesitamos que completes el siguiente
                                formulario
                            ...
                            <form class="row g-3 " action="" method="post" id="formulario">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-danger d-none" id="mesaje_fecha_nacimiento">El campo fecha debe
                                        cumplir
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="numero_tarjeta" name="numero_tarjeta"
                                        required="">
                                    <p class="text-danger d-none" id="mesaje_numero_tarjeta">El campo debe cumplir con
                                        lo
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <input type="button" value="Registrar" onclick="registrar(event)"
